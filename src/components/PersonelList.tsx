...
import {Member} from '../models/organizationModels';

interface personelListProps {
  item: Member;
}

const PersonelList: React.FC<personelListProps> = ({item}) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={GlobalTextStyle.textSmallBlack}>{item.office}</Text>
      </View>
    </View>
  );
};
