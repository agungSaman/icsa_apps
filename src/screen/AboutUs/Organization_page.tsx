...
import OrgChartScreen from './Component/org_chart';
import OrgPersonnelScreen from './Component/org_personnel';

const renderScene = SceneMap({
  first: OrgChartScreen,
  second: OrgPersonnelScreen,
});
    ...
    <View style={globalStyles.safeArea}>
      <View style={globalStyles.container}>
        <View style={globalStyles.responsiveBox}>
          <MyAppBar title="Organization" isHome={false} isRegisters={false} />
